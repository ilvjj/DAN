...
np.save('../Datasets/SYSU-MM01/' + 'train_rgb_resized_img.npy', train_img)
np.save('../Datasets/SYSU-MM01/' + 'train_rgb_resized_label.npy', train_label)

# ir imges
train_img, train_label = read_imgs(files_ir)
np.save('../Datasets/SYSU-MM01/' + 'train_ir_resized_img.npy', train_img)
np.save('../Datasets/SYSU-MM01/' + 'train_ir_resized_label.npy', train_label)
